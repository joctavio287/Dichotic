...
for SCRAMBLED_PROBE in [False, True]:
    ...
    probe_profile_path = attention_probe_path.with_name(attention_probe_path.stem + f'_{PROBE_TEXT}_{int(PROBE_DURATION*1000)}_profile.png')
